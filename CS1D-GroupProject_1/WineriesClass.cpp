...
//			while(index < totalWineries && notFound)
//			{
//				if(nextAccount.name < Wineries[index].name)
//				{
//					Wineries.insert(it, nextAccount);
//					notFound = false;
//				}
//				else if(index == totalWineries - 1)
//				{
//					Wineries.push_back(nextAccount);
//					notFound = false;
//				}
//				it++;
//				index++;
...
//bool Wineries::LogIn(bool &adminStatus)
//{
//	bool loginOk = false;
//	adminStatus = false;
//	int admin = 0;
...
//		if(loginOk)
//		{
//			admin = Wineries[count-1].adminStatus;
...
//}//END - LogIn
//
////Close Wineries method will output to a file a current and comprehensive
////list of all the usernames and passwords currently in the program
//void Wineries::CloseWineries()
//{
//	ofstream outFile;
//
...
//
//	for(unsigned int i = 0; i < Wineries.size(); i++)
//	{
//		outFile << Wineries[i].name 		 << endl;
//		outFile << Wineries[i].address 		 << endl;
//		outFile << Wineries[i].city 		 << endl;
//		outFile << Wineries[i].state		 << endl;
//		outFile << Wineries[i].zip 			 << endl;
//		outFile << Wineries[i].theirInterest << endl;
//		outFile << Wineries[i].ourInterest 	 << endl;
//		outFile << Wineries[i].adminStatus 	 << endl;
//		outFile << Wineries[i].username 	 << endl;
//		outFile << Wineries[i].password;
//
//		if(i != Wineries.size() - 1)outFile << endl << endl;
//	}
//
//	outFile.close();
//}//END - CloseWineries
...
//int Wineries::GetTotWineries()
//{
//	return totalWineries;
//}//END - GetTotWineries
//
////takes in a username and searches through the queue for any same usernames
//bool Wineries::CheckLogin(string username, string password, unsigned int i,
//		int &count)
//{
//	bool loginOk = false;
//	i = 0;
//
//	while(i < Wineries.size() && !loginOk)
//	{
//		//checking against the passed in username and password
//		loginOk = Wineries[i].username == username &&
//				  Wineries[i].password == password;
//		i++;
//	}
//
//	count = i;
...
//	for(unsigned int i = 0; i < Wineries.size(); i++)
//	{
//		cout << "Company Name: " << Wineries[i].name << endl;
//		cout << "Company Address: " << Wineries[i].address << endl;
//		cout << Wineries[i].city << ", ";
//		cout << Wineries[i].state << " ";
//		cout << Wineries[i].zip << endl;
//		cout << "Their Interest: " << Wineries[i].theirInterest << endl;
//		cout << "Our Interest: " << Wineries[i].ourInterest << endl;
//		if (Wineries[i].adminStatus == 0)
//		{
...
//		}
//
//		cout << "Username: " << Wineries[i].username << endl;
//		if(i <= Wineries.size())cout << endl;
//	}
//	cout << endl << endl;
//	system("pause");
//}//END - Print
...
//bool Wineries::CheckUsername(string username)
//{
...
//	while(i < Wineries.size() && !sameUsername)
//	{
//		tempAccount = Wineries[i].username ;
//		bool sameName;
...
//}
//
//bool Wineries::CheckAdmin(bool adminStatus, int admin)
//{
